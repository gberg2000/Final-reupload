...
Changes made:
- Change background 
- added second player one using WASD and the other using arrowkeys
- Change sprites for player2 and platforms 
Game ideas:
- instead of platforms make them walls moving down with gaps to jump through
- remember and display high scores 
- add solo and vs modes 

Bugs:
- trouble getting collision and a new sprite for player2 - 'bool' object is not callable - once you get past the intro screen the game closes 
- the blue background from the intro screen covers the space background in game - resolved
'''
import pygame as pg
import random
...
class Game:
    ...
    def draw(self):
        ...
        # changes the background image while in game to space
        background_image = pg.image.load("space.jpg").convert()
    ...
    def show_start_screen(self):
        ...
        self.draw_text("WASD for Player1, Arrow keys for Player2 ", 22, WHITE, WIDTH/2, HEIGHT/2)
